              ...
              <div class="row mb-2">
                ...
                <div class="col-sm-6">
                  <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="/all-lisensi">Pengajuan Lisensi</a></li>
                    <li class="breadcrumb-item active">Edit Pengajuan Lisensi</li>
                  </ol>
                </div><!-- /.col -->
              </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                    ...
                    <div class="card-body">
                        <form role="form" action="{{ URL::to('/update-toko/'.$edit->id) }}" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" name="" placeholder="Masukkan Nama Toko" value="{{ $edit->jmlkom }}">
                                </div>
                            </div>
